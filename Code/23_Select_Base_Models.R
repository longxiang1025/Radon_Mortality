...
#     cv_pred_base_list[[i]]=cv_pred_base%>%dplyr::select(obs,pred,weights,rowIndex)
#   }else{
#     cv_pred_base_list[[i]]=cv_pred_base%>%dplyr::select(obs,pred,N,rowIndex)
#     names(cv_pred_base_list[[i]])=c("obs","pred","weights","rowIndex")
#   }
...
#  print(i)
#}
#common_para_list=bind_rows(common_para_list)
